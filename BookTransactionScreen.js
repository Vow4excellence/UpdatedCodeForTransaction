...
//updated render function to have 2 input boxes each for book id and student id
//each inout box has a SCAN button
//the styles sheet added for the input box and scan button
// once id scanned then user need to click on submit button 
//
...
//scan Book ID box and SCAN button
<View style= {styles.inputView}>
  <TextInput 
  style={styles.inputText} placeholder = "Book Id" 
